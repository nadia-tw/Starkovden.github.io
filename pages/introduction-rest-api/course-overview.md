...
На этом курсе по созданию документации REST API, вместо простых разговоров об абстрактных понятиях, мы будем применять практический подход к документированию REST API. Изучим документацию API на примере использования различных API сервисов погоды.
